...
inf.rate.out<-c(0.25,0.4,0.6,0.8)
inf.rate.in<-0.2
removal.rate.all<-0.2
mutation.rate<-c(0.00002,0.00005,0.0001)
introduction.rate<-0
nums<-0
seq.error<-0.05
seq.error.rem<-0.05
  ...
  for (m in c(1,3)){
    for (n in c(1,3)){
      ...
      W<-simulate_outbreak(init.sus = init.sus,init.sus.in=0,
                           ...
                           samp.freq = 10, mut.prob.site.out = mutation.rate[n]/(inf.rate.out[m]*1/removal.rate.all), 
      ...
      if (length(unique(c(df$from,df$to)))>101) break
      }
      df<-df[-1,]
...
saveRDS(plots, file="ROC_curves_sims_small_131222.RData")
print("finished")

plots<-readRDS("ROC_curves_sims_small_131222.RData")
tiff(filename="ROC_curves_final_figure2supp.tiff", res = 300, units = "cm",width = 30,height = 20)
p5<-ggarrange(plots[[1]]+ xlab(NULL) +labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 1.25 \nMutation rate = 2e-05",size = 3) +theme_bw(),
              plots[[2]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 1.25 \nMutation rate = 1e-04",size = 3) +theme_bw(),
              plots[[3]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 3 \nMutation rate = 2e-05",size = 3) +theme_bw(),
              plots[[4]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 3 \nMutation rate = 1e-04",size = 3) +theme_bw(),
              plots[[5]]+ xlab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 1.25 \nMutation rate = 2e-05",size = 3) +theme_bw(),
              plots[[6]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 1.25 \nMutation rate = 1e-04",size = 3) +theme_bw(),
              plots[[7]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 3 \nMutation rate = 2e-05",size = 3) +theme_bw(),
              plots[[8]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 3 \nMutation rate = 1e-04",size = 3) +theme_bw(),
              plots[[9]]+ xlab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 1.25 \nMutation rate = 2e-05",size = 3) +theme_bw(),
              plots[[10]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 1.25 \nMutation rate = 1e-04",size = 3) +theme_bw(),
              plots[[11]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 3 \nMutation rate = 2e-05",size = 3) +theme_bw(),
              plots[[12]]+ xlab(NULL) + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 3 \nMutation rate = 1e-04",size = 3) +theme_bw(),
              plots[[13]]+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 1.25 \nMutation rate = 2e-05",size = 3) +theme_bw(),
              plots[[14]] + ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 1.25 \nMutation rate = 1e-04",size = 3) +theme_bw(),
              plots[[15]]+ ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 3 \nMutation rate = 2e-05",size = 3) +theme_bw(),
              plots[[16]]+ ylab(NULL)+labs(title=NULL) + annotate("text",x = 0.7, y = 0.25, label ="R number = 3 \nMutation rate = 1e-04",size = 3) +theme_bw(),
